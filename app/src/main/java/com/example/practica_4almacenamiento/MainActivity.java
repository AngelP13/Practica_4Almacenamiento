package com.example.practica_4almacenamiento;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void mostrarVuelos() {
        Intent intent = new Intent(this, MostrarVuelos.class);
    ...
    private void registrarAerolinea() {
        ...
        View view = getLayoutInflater().inflate(R.layout.registrar_aerolinea, null);
